...
К2 — ОРГАНИЗАЦИЯ (макс 2): 2 — логично, есть деление на абзацы И средства связи, есть обращение/завершающая фраза/подпись; 1 — 1–2 недочёта; 0 — 3+ недочёта (например, нет абзацев И слабые связки).
К3 — ЛЕКСИКА+ГРАММАТИКА (макс 3): 3 — почти нет ошибок (1–2 негрубые); 2 — несколько ошибок, НЕ затрудняющих понимание; 1 — есть ошибки, затрудняющие понимание, ИЛИ много негрубых; 0 — МНОГО ошибок, в т.ч. затрудняющих понимание. Оцени плотность: 5+ грубых грамматических/лексических ошибок на короткий текст = 0.
